...
export const lightTheme = {
  ...
  phases: {
    ...
    awaiting_review: { fg: '#b45309', bg: 'rgba(245,158,11,0.16)' },
    issue_reported: { fg: '#c2410c', bg: 'rgba(248,113,113,0.14)' },
  ...
  notificationTypes: {
    ...
    awaiting_review: { fg: '#b45309', bg: 'rgba(245,158,11,0.16)', icon: 'rate-review' },
    issue_reported: { fg: '#c2410c', bg: 'rgba(248,113,113,0.14)', icon: 'report-problem' },
...
export const darkTheme = {
  ...
  phases: {
    ...
    awaiting_review: { fg: '#fbbf24', bg: 'rgba(251,191,36,0.18)' },
    issue_reported: { fg: '#fb923c', bg: 'rgba(251,146,60,0.16)' },
  ...
  notificationTypes: {
    ...
    awaiting_review: { fg: '#fbbf24', bg: 'rgba(251,191,36,0.18)', icon: 'rate-review' },
    issue_reported: { fg: '#fb923c', bg: 'rgba(251,146,60,0.16)', icon: 'report-problem' },
