...
export function WasherTrustCompactBar() {
  ...
  return (
    <m.div
      ...
      className="mx-auto mt-2 flex max-w-lg flex-wrap items-center gap-1.5 rounded-2xl border border-white/12 bg-gradient-to-r from-white/50 to-white/30 px-2 py-1.5 shadow-sm ring-1 ring-black/[0.04] backdrop-blur-md dark:from-white/[0.07] dark:to-white/[0.03] dark:ring-white/10"
    >
      {t.safetyVerified ? (
