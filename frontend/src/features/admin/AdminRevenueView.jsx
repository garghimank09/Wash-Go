    ...
    >
      <m.div variants={adminSectionItem(reduced)} className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-1 max-w-2xl text-sm text-wg-muted">Gross performance, pipeline, and satisfaction economics (mock).</p>
        </div>
        <Link
          to="/admin"
      ...
      <m.div variants={adminSectionItem(reduced)}>
        <Card variant="glass" className="border-l-4 border-l-violet-500/50 border-white/15 p-4 dark:border-white/10">
      ...
      <div className="grid min-w-0 gap-6 xl:grid-cols-3">
        <m.div variants={adminSectionItem(reduced)} className="min-w-0 space-y-6 xl:col-span-2">
        ...
        <m.div variants={adminSectionItem(reduced)} className="min-w-0 space-y-6">
