...
export function AdminCustomerGrowthChart({ data, chartsReady }) {
  if (!chartsReady) {
    return (
      <Card variant="glass" className="min-h-[220px] min-w-0">
        ...
        <p className="mt-1 text-xs text-wg-muted">Monthly signups vs cumulative base (mock).</p>
        <div className="mt-6">
  ...
  return (
    <Card variant="glass" className="min-h-[220px] min-w-0 transition hover:ring-1 hover:ring-cyan-500/20 dark:hover:ring-cyan-400/15">
      <div>
        <h2 className="wg-heading-section">Customer growth</h2>
        <p className="mt-1 text-xs text-wg-muted">Monthly signups and cumulative customers (mock).</p>
      </div>
