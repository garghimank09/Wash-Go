...
export function AdminRepeatCustomerCard({ repeatPct, bookings30d }) {
  return (
    <Card variant="glass" className="border-l-4 border-l-indigo-500/55 border-white/20 p-4 dark:border-white/10">
      <div className="flex items-start gap-3">
        ...
        <div>
          ...
          <p className="mt-1 text-xs leading-relaxed text-wg-muted">
            Of bookings in the last 30d, {repeatPct}% are from returning customers — cohort retention signal (mock).
          </p>
          {bookings30d != null ? (
