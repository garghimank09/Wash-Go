...
export const CUSTOMER_DEMO_PHONE = '9876543211';
export const PARTNER_DEMO_PHONE = '9876543212';

export const DEMO_EMAILS = [ADMIN_DEMO_EMAIL, 'customer@washgo.demo', 'partner@washgo.demo'];

export const DEMO_PHONES = [ADMIN_DEMO_PHONE, CUSTOMER_DEMO_PHONE, PARTNER_DEMO_PHONE];
...
export function isCustomerDemoPhone(phone) {
  return normalizeIndianPhoneDigits(phone) === CUSTOMER_DEMO_PHONE;
}

export function isPartnerDemoPhone(phone) {
  return normalizeIndianPhoneDigits(phone) === PARTNER_DEMO_PHONE;
}
...
export const CUSTOMER_LOGIN_ONLY_MESSAGE =
  'Customer demo uses mobile 9876543211 — sign in at /login, not the partner portal.';

export const PARTNER_LOGIN_ONLY_MESSAGE =
  'Partner demo uses mobile 9876543212 — sign in at /partner/login, not here.';
