...
2. **Backend** — from `backend/`: `python run.py` (API on **port 8001** by default).
3. **Frontend** — ensure **`frontend/.env`** exists with **`VITE_API_URL=http://127.0.0.1:8001`**. Restart **`npm run dev`** after changing `.env`.
